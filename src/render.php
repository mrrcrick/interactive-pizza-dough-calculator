...
>
	<div class="panel">
		...
		<div class="form-group">
			<input type="number" placeholder="No. of Pizza" data-wp-on--change="actions.pizzas">
		</div>

		<div class="form-group">
			<input type="number" placeholder="Weight of doughball (g)" data-wp-on--change="actions.weight">
		</div>

		<div class="form-group">
			<input type="number" name="hydration" placeholder="Hydration (%)" data-wp-on--change="actions.hydration">
		</div>
	</div>
